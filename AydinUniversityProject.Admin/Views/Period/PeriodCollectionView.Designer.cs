namespace AydinUniversityProject.Admin.Views.PeriodCollectionView {
    partial class PeriodCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
			...
			this.periodCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.periodCollectionViewBindingSource.DataSource = typeof(AydinUniversityProject.Data.POCOs.Period);
			this.gridControl.DataSource = periodCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters LessonsPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            LessonsPopulateColumnParameters_NotVisible.FieldName = "Lessons";
		    LessonsPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(LessonsPopulateColumnParameters_NotVisible);
				
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters StudentsPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            StudentsPopulateColumnParameters_NotVisible.FieldName = "Students";
		    StudentsPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(StudentsPopulateColumnParameters_NotVisible);
			 
			this.gridView.PopulateColumns(typeof(AydinUniversityProject.Data.POCOs.Period),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(AydinUniversityProject.Admin.ViewModels.PeriodCollectionViewModel);
			// 
            // layoutControl
            // 
            ...
            this.Name = "PeriodCollectionView";
		...
		private System.Windows.Forms.BindingSource periodCollectionViewBindingSource;
