...
namespace AydinUniversityProject.Admin.Views.TopicCollectionView{
    public partial class TopicCollectionView : XtraUserControl {
        public TopicCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<AydinUniversityProject.Admin.ViewModels.TopicCollectionViewModel>();
