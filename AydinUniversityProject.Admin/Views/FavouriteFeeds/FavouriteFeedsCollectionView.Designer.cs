namespace AydinUniversityProject.Admin.Views.FavouriteFeedsCollectionView {
    partial class FavouriteFeedsCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.labelControl.Text = "FavouriteFeeds";
			// 
            // gridControl
            // 
			...
			this.favouriteFeedsCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.favouriteFeedsCollectionViewBindingSource.DataSource = typeof(AydinUniversityProject.Data.POCOs.FavouriteFeeds);
			this.gridControl.DataSource = favouriteFeedsCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters FavouriteTopicsPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            FavouriteTopicsPopulateColumnParameters_NotVisible.FieldName = "FavouriteTopics";
		    FavouriteTopicsPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(FavouriteTopicsPopulateColumnParameters_NotVisible);
				
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters FavouritePostsPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            FavouritePostsPopulateColumnParameters_NotVisible.FieldName = "FavouritePosts";
		    FavouritePostsPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(FavouritePostsPopulateColumnParameters_NotVisible);
			 
			this.gridView.PopulateColumns(typeof(AydinUniversityProject.Data.POCOs.FavouriteFeeds),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(AydinUniversityProject.Admin.ViewModels.FavouriteFeedsCollectionViewModel);
			// 
            // layoutControl
            // 
            ...
            this.Name = "FavouriteFeedsCollectionView";
		...
		private System.Windows.Forms.BindingSource favouriteFeedsCollectionViewBindingSource;
