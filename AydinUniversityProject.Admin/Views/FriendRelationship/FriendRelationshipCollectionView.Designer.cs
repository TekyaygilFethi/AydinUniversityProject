namespace AydinUniversityProject.Admin.Views.FriendRelationshipCollectionView {
    partial class FriendRelationshipCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.labelControl.Text = "FriendRelationship";
			// 
            // gridControl
            // 
			...
			this.friendRelationshipCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.friendRelationshipCollectionViewBindingSource.DataSource = typeof(AydinUniversityProject.Data.POCOs.FriendRelationship);
			this.gridControl.DataSource = friendRelationshipCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters FriendsPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            FriendsPopulateColumnParameters_NotVisible.FieldName = "Friends";
		    FriendsPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(FriendsPopulateColumnParameters_NotVisible);
			 
			this.gridView.PopulateColumns(typeof(AydinUniversityProject.Data.POCOs.FriendRelationship),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(AydinUniversityProject.Admin.ViewModels.FriendRelationshipCollectionViewModel);
			// 
            // layoutControl
            // 
			...
			//
			//FriendRelationshipCollectionView
			//
            ...
            this.Name = "FriendRelationshipCollectionView";
		...
		private System.Windows.Forms.BindingSource friendRelationshipCollectionViewBindingSource;
