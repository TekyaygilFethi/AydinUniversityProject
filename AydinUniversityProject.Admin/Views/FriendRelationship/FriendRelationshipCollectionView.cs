...
namespace AydinUniversityProject.Admin.Views.FriendRelationshipCollectionView{
    public partial class FriendRelationshipCollectionView : XtraUserControl {
        public FriendRelationshipCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<AydinUniversityProject.Admin.ViewModels.FriendRelationshipCollectionViewModel>();
            ...
            fluentAPI.WithEvent<GridView, FocusedRowObjectChangedEventArgs>(gridView, "FocusedRowObjectChanged")
                .SetBinding(x => x.SelectedEntity,
                    args => args.Row as AydinUniversityProject.Data.POCOs.FriendRelationship,
