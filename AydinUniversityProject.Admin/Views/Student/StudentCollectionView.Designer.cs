namespace AydinUniversityProject.Admin.Views.StudentCollectionView {
    partial class StudentCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
			...
			this.studentCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.studentCollectionViewBindingSource.DataSource = typeof(AydinUniversityProject.Data.POCOs.Student);
			this.gridControl.DataSource = studentCollectionViewBindingSource;
            ...
            UserPopulateColumnParameters.Path = "User.Username";
            ...
            UserPopulateColumnParameters_NotGenerate.FieldName = "ID";
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters NameSurnamePopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            NameSurnamePopulateColumnParameters_NotVisible.FieldName = "NameSurname";
		    NameSurnamePopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(NameSurnamePopulateColumnParameters_NotVisible);
			 
			this.gridView.PopulateColumns(typeof(AydinUniversityProject.Data.POCOs.Student),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(AydinUniversityProject.Admin.ViewModels.StudentCollectionViewModel);
			// 
            // layoutControl
            // 
            ...
            this.Name = "StudentCollectionView";
		...
		private System.Windows.Forms.BindingSource studentCollectionViewBindingSource;
