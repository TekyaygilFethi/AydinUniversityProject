...
namespace AydinUniversityProject.Admin.Views.StudentCollectionView{
    public partial class StudentCollectionView : XtraUserControl {
        ...
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<AydinUniversityProject.Admin.ViewModels.StudentCollectionViewModel>();
