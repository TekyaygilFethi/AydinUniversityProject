namespace AydinUniversityProject.Admin.Views.ContactView {
    partial class ContactView {
		...
		private void InitializeComponent() {
			...
			this.contactViewBindingSource.DataSource = typeof(AydinUniversityProject.Data.POCOs.Contact);
			this.dataLayoutControl1.DataSource = contactViewBindingSource;
			//
			//Create GridControls
			//
            ...
            this.mvvmContext.ViewModelType = typeof(AydinUniversityProject.Admin.ViewModels.ContactViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "Contact - Element View";
