...
namespace AydinUniversityProject.Admin.Views.ScreenShareRequestCollectionView{
    public partial class ScreenShareRequestCollectionView : XtraUserControl {
        public ScreenShareRequestCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<AydinUniversityProject.Admin.ViewModels.ScreenShareRequestCollectionViewModel>();
