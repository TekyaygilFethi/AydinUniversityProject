namespace AydinUniversityProject.Admin.Views.FriendRequestView {
    partial class FriendRequestView {
		...
		private void InitializeComponent() {
			...
			this.friendRequestViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.friendRequestViewBindingSource.DataSource = typeof(AydinUniversityProject.Data.POCOs.FriendRequest);
			this.dataLayoutControl1.DataSource = friendRequestViewBindingSource;
			//
			//Create GridControls
			//
			...
			this.RequesterLookUpEdit.DataBindings.Add("EditValue", friendRequestViewBindingSource, "RequesterID", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			...
			this.RequestToLookUpEdit.DataBindings.Add("EditValue", friendRequestViewBindingSource, "RequestToID", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            this.mvvmContext.ViewModelType = typeof(AydinUniversityProject.Admin.ViewModels.FriendRequestViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "FriendRequest - Element View";
		...
		private System.Windows.Forms.BindingSource friendRequestViewBindingSource;
