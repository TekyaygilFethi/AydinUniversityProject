...
namespace AydinUniversityProject.Admin.Views.FriendRequestCollectionView{
    public partial class FriendRequestCollectionView : XtraUserControl {
        public FriendRequestCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<AydinUniversityProject.Admin.ViewModels.FriendRequestCollectionViewModel>();
