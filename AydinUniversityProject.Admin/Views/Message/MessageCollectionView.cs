...
namespace AydinUniversityProject.Admin.Views.MessageCollectionView{
    public partial class MessageCollectionView : XtraUserControl {
        ...
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<AydinUniversityProject.Admin.ViewModels.MessageCollectionViewModel>();
