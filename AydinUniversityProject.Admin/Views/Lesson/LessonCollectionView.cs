...
namespace AydinUniversityProject.Admin.Views.LessonCollectionView{
    public partial class LessonCollectionView : XtraUserControl {
        public LessonCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<AydinUniversityProject.Admin.ViewModels.LessonCollectionViewModel>();
