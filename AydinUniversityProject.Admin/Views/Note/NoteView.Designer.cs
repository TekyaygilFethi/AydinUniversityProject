namespace AydinUniversityProject.Admin.Views.NoteView {
    partial class NoteView {
		...
		private void InitializeComponent() {
			...
			this.labelControl = new DevExpress.XtraEditors.LabelControl();
									this.EducationLookUpEdit = new DevExpress.XtraEditors.GridLookUpEdit();
			...
			this.noteViewBindingSource.DataSource = typeof(AydinUniversityProject.Data.POCOs.Note);
			this.dataLayoutControl1.DataSource = noteViewBindingSource;
			//
			//Create GridControls
			//
			...
			//EducationLookUpEdit
			//
			this.EducationBindingSource.DataSource = typeof(AydinUniversityProject.Data.POCOs.Education);
			this.EducationLookUpEdit.Properties.ValueMember = "ID"; 
			this.EducationLookUpEdit.Properties.DisplayMember = "ID";
			this.EducationLookUpEdit.Properties.DataSource = this.EducationBindingSource;
			this.EducationLookUpEdit.Name = "EducationLookUpEdit";
			this.EducationLookUpEdit.DataBindings.Add("EditValue", noteViewBindingSource, "EducationID", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			DevExpress.XtraDataLayout.RetrieveFieldParameters EducationLookUpEditRetrieveFieldParameters = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
            EducationLookUpEditRetrieveFieldParameters.FieldName = "EducationID";
            EducationLookUpEditRetrieveFieldParameters.ControlForField = this.EducationLookUpEdit;
			parameters.CustomListParameters.Add(EducationLookUpEditRetrieveFieldParameters);
			DevExpress.XtraDataLayout.RetrieveFieldParameters EducationLookUpEditRetrieveFieldParameters_NotGenerate = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
		    EducationLookUpEditRetrieveFieldParameters_NotGenerate.FieldName = "Education";
		    EducationLookUpEditRetrieveFieldParameters_NotGenerate.GenerateField = false;
			parameters.CustomListParameters.Add(EducationLookUpEditRetrieveFieldParameters_NotGenerate);
            ...
            this.mvvmContext.ViewModelType = typeof(AydinUniversityProject.Admin.ViewModels.NoteViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "Note - Element View";
		...
		private System.Windows.Forms.BindingSource noteViewBindingSource;
						private DevExpress.XtraEditors.GridLookUpEdit EducationLookUpEdit;
