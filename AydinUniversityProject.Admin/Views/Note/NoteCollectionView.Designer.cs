namespace AydinUniversityProject.Admin.Views.NoteCollectionView {
    partial class NoteCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
			...
			this.noteCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.noteCollectionViewBindingSource.DataSource = typeof(AydinUniversityProject.Data.POCOs.Note);
			this.gridControl.DataSource = noteCollectionViewBindingSource;
			...
			//Education
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters EducationPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            EducationPopulateColumnParameters.FieldName = "Education";
            EducationPopulateColumnParameters.Path = "Education.ID";
			parameters.CustomColumnParameters.Add(EducationPopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters EducationPopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            EducationPopulateColumnParameters_NotGenerate.FieldName = "EducationID";
		    EducationPopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(EducationPopulateColumnParameters_NotGenerate);
										
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters EducationPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            EducationPopulateColumnParameters_NotVisible.FieldName = "Education";
		    EducationPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(EducationPopulateColumnParameters_NotVisible);
			 
			this.gridView.PopulateColumns(typeof(AydinUniversityProject.Data.POCOs.Note),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(AydinUniversityProject.Admin.ViewModels.NoteCollectionViewModel);
			// 
            // layoutControl
            // 
		...
		private System.Windows.Forms.BindingSource noteCollectionViewBindingSource;
