...
namespace AydinUniversityProject.Admin.Views.PostCollectionView{
    public partial class PostCollectionView : XtraUserControl {
        ...
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<AydinUniversityProject.Admin.ViewModels.PostCollectionViewModel>();
