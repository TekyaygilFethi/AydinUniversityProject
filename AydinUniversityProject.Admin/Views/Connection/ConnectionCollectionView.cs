...
namespace AydinUniversityProject.Admin.Views.ConnectionCollectionView{
    public partial class ConnectionCollectionView : XtraUserControl {
        public ConnectionCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<AydinUniversityProject.Admin.ViewModels.ConnectionCollectionViewModel>();
