namespace AydinUniversityProject.Admin.Views.SentFeedsCollectionView {
    partial class SentFeedsCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.labelControl.Text = "SentFeeds";
			// 
            // gridControl
            // 
			...
			this.sentFeedsCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.sentFeedsCollectionViewBindingSource.DataSource = typeof(AydinUniversityProject.Data.POCOs.SentFeeds);
			this.gridControl.DataSource = sentFeedsCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters SentTopicsPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            SentTopicsPopulateColumnParameters_NotVisible.FieldName = "SentTopics";
		    SentTopicsPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(SentTopicsPopulateColumnParameters_NotVisible);
				
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters SentPostsPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            SentPostsPopulateColumnParameters_NotVisible.FieldName = "SentPosts";
		    SentPostsPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(SentPostsPopulateColumnParameters_NotVisible);
			 
			this.gridView.PopulateColumns(typeof(AydinUniversityProject.Data.POCOs.SentFeeds),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(AydinUniversityProject.Admin.ViewModels.SentFeedsCollectionViewModel);
			// 
            // layoutControl
            // 
            ...
            this.Name = "SentFeedsCollectionView";
		...
		private System.Windows.Forms.BindingSource sentFeedsCollectionViewBindingSource;
