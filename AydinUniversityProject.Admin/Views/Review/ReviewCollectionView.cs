...
namespace AydinUniversityProject.Admin.Views.ReviewCollectionView{
    public partial class ReviewCollectionView : XtraUserControl {
        public ReviewCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<AydinUniversityProject.Admin.ViewModels.ReviewCollectionViewModel>();
